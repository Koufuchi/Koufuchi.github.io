!function (t) {
    ...
    var k = function (t) {
        ...
        return r(e, t), Object.defineProperty(e.prototype, "blocks", {
            ...
            var n, o, r, i, s = { i: t - 1, j: e }, a = { i: t + 1, j: e };
            0 == (1 & e) ? (n = { i: t - 1, j: e - 1 }, o = { i: t, j: e - 1 }, r = { i: t - 1, j: e + 1 }, i = {
                i: t,
                j: e + 1
            ...
            if (this.cat.anims.isPlaying && this.cat.anims.stop(), this.state !== i.PLAYING) return this.setStatusText(f.default("遊戲已經結束，重新開局")), this.reset(), !1;
            var n = this.getBlock(t, e);
            return n ? n.isWall ? (this.setStatusText(f.default("點擊位置已經是牆了，禁止點擊")), !1) : this.cat.i === t && this.cat.j === e ? (this.setStatusText(f.default("點擊位置是貓當前位置，禁止點擊")), !1) : (n.isWall = !0, this.cat.isCaught() ? (this.setStatusText(f.default("貓已經無路可走，你贏了")), this.state = i.WIN, !1) : (this.setStatusText(f.default("您點擊了 ") + "(" + t + ", " + e + ")"), this.cat.step() || (this.setStatusText(f.default("貓認輸，你贏了！")), this.state = i.WIN), !0)) : (this.setStatusText(f.default("代碼錯誤，當前位置不存在")), !1)
        }, e.prototype.reset = function () {
            this.cat.reset(), this.resetBlocks(), this.randomWall(), this.state = i.PLAYING, this.setStatusText(f.default("點擊小圓點，圍住小貓"))
            ...
            var t = this, e = new a.default(this);
            e.on("escaped", function () {
                t.state = i.LOSE
            }), e.on("win", function () {
                t.state = i.WIN
            }), e.solver = p.default, this.cat = e, this.add.existing(e)
            ...
            var t = this, e = new d.default(this);
            ...
            for (var t = 0; t < 8; t++) {
                var e = Math.floor(this.w * Math.random()), n = Math.floor(this.h * Math.random());
    ...
    "use strict";
    Object.defineProperty(e, "__esModule", { value: !0 });
    var o = n(5), r = n(6), i = n(7), s = n(8), a = n(9), l = n(10), d = n(11), h = n(12), u = n(13), f = n(14),
        p = n(15), c = n(16), k = n(17), g = n(18), w = n(19);
    e.default = {
        textures: {
            bottom_left_1: o,
            bottom_left_2: r,
        ...
        origins: { left: { x: .75, y: .75 }, top_left: { x: .63, y: .83 }, bottom_left: { x: .65, y: .5 } },
        ...
        directions: [{ scaleX: 1, name: "left" }, { scaleX: 1, name: "top_left" }, {
            scaleX: -1,
            name: "top_left"
        }, { scaleX: -1, name: "left" }, { scaleX: -1, name: "bottom_left" }, { scaleX: 1, name: "bottom_left" }],
    ...
    Object.defineProperty(e, "__esModule", { value: !0 });
    var i = n(0), s = function (t) {
        function e(e) {
            var n = this;
            e.credit || (e.credit = "github.com/ganlvtech"), e.backgroundColor || (e.backgroundColor = 15658734);
            var o = e.w, r = e.h, s = e.r * window.devicePixelRatio, a = 1 / window.devicePixelRatio,
                l = Math.floor((6.5 + 2 * o) * s), d = Math.floor((6 + Math.sqrt(3) * r) * s),
                h = new i.default(o, r, s), u = {
                    width: l,
                    height: d,
                    type: Phaser.AUTO,
                    parent: e.parent,
 ...
 */
    ...
    Object.defineProperty(e, "__esModule", { value: !0 });
    var i = n(0), s = n(1), a = n(21), l = function (t) {
        function e(e) {
            var n = t.call(this, e, 0, 0, "__DEFAULT") || this;
            return n.on("animationrepeat", function () {
                n.moveForward()
            }), n.solver = a.default, n.direction = s.default.catDefaultDirection, n.reset(), n
        }
        ...
        return r(e, t), Object.defineProperty(e.prototype, "i", {
            ...
            var t = s.default.directions[this.direction], e = s.default.origins[t.name];
            ...
            var t = this, e = this.getCurrentNeighbours()[this.direction], n = this.scene.getBlock(e.i, e.j);
            return null !== n && (!n.isWall && (this.play(s.default.directions[this.direction].name + "_step"), this.once("animationcomplete", function () {
    ...
    var i = function (t) {
        function e(e, n, o, r) {
            var i = this, s = e.getPosition(n, o);
    ...
    var i = n(2), s = function (t) {
        function e(e) {
            var n = t.call(this, e, 0, 0, i.default("重新開始"), {}) || this;
            n.setColor("rgb(243,11,11)");
            var o = e.r;
    ...
    var o = n(0), r = function () {
        ...
        return Object.defineProperty(t.prototype, "routesCount", {
            get: function () {
                var t = this;
                if (void 0 === this._routesCount) if (this.isEdge) this._routesCount = 1; else {
                    var e = 0;
